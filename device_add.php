...
<head>
    ...
    <script type="javascript">
        ...
        function fc(){
            document.getElementsByName('sensor_board');
        }
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h5>Add a sensor<small>  to an available sensor board </small></h5>
                            </div>
                            <div class="ibox-content">
                                <form method="post" action="php/AddSensor.php" class="form-horizontal">
                                    <div class="form-group"><label class="col-sm-2 control-label">Select Sensor Board</label>
                                        <div class="col-sm-10"><select class="form-control m-b" name="sensor_board">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control m-b" name="sensor_type">
                                                ...
                                                <?php
                                                    ...
                                                    $sensorTypes = $sensorTypeController->selectAll();
                                                    foreach($sensorTypes as $sensorType){
                                                        echo '<option value="'.$sensorType->getIdsensorType().'">'.$sensorType->getTypeName().'</option>';
                                                    }
                                                ?>
                                            </select>
                                        </div>
