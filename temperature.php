...
<head>
    ...
    <script type="text/javascript" src="js/ajax/TemperatureReading.js"></script>
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal">
                                <div class="form-group"><label class="col-sm-2 control-label">Select Location</label>
                                    <div class="col-sm-10">
                                        <select class="form-control m-b" name="location" id="location" onchange="showTemperature()">
                    ...
                    <div class="widget style1 yellow-bg">
                        <div class="row">
                            ...
                            <div class="col-xs-8 text-right">
                                ...
                                <h2 class="font-bold"><div id="avgtemperature"></div></h2>
                            </div>
                        </div>
                    </div>
                </div>
