            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Add a manufacturer <small>  to the system </small></h5>
                    </div>
                    <div class="ibox-content">
                        <form method="post" action="php/AddManufacturer.php" class="form-horizontal">
                            <div class="form-group"><label class="col-sm-2 control-label">Manufacturer Name</label>
                                <div class="col-sm-10"><input type="text" name="manufacturer_name" class="form-control" required></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">Address Number</label>
                                <div class="col-sm-10"><input type="text" name="address_number" class="form-control" required></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">Address Street</label>
                                <div class="col-sm-10"><input type="text" name="address_street" class="form-control" required></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">Address Country</label>
                                <div class="col-sm-10"><input type="text" name="address_country" class="form-control" required></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">Address City</label>
                                <div class="col-sm-10"><input type="text" name="address_city" class="form-control" required></div>
                            </div>

                            <div class="form-group"><label class="col-sm-2 control-label">Contact Number</label>
                                <div class="col-sm-10"><input type="text" name="contact_number" class="form-control" required></div>
                            </div>
